-- Gazette du Match : régénération admin + effacement au retour « à venir ».

comment on column public.matches.ai_summary is
  'Résumé IA « Gazette du Match ». Effacé si le match repasse en à venir ; régénérable par l''admin.';

-- -----------------------------------------------------------------------------
-- save_match_ai_summary : autoriser l''écrasement (régénération)
-- -----------------------------------------------------------------------------
drop function if exists public.save_match_ai_summary(integer, text);
...
grant execute on function public.save_match_ai_summary(integer, text, boolean) to authenticated;

-- -----------------------------------------------------------------------------
-- admin_update_match : effacer la Gazette si repasse en scheduled
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- reopen_match_settlement : effacer la Gazette si repasse en scheduled
-- -----------------------------------------------------------------------------
