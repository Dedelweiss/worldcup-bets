-- Permettre de modifier (ou changer de type) un pronostic classique tant que le match n'a pas démarré.
...
begin
  ...
  if v_existing_id is not null then
    ...
    set
      ...
      is_boosted = case
        when p_bet_type = 'match_result' then coalesce(p_use_boost, false)
        else false
      end
