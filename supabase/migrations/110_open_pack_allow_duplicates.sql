-- Autorise les doublons dans un même pack ; conserve ~92 % joueurs / ~8 % spéciales par slot.
...
comment on function public.open_pack(uuid) is
  'Ouvre un pack : ~92 % joueurs par slot, ~8 % spéciales ; doublons autorisés dans le même pack.';
